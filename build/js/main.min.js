...
/* harmony import */ var _modules_toggle_header_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/toggle-header-menu */ "./js/modules/toggle-header-menu.js");
/* harmony import */ var _modules_toggle_header_menu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_toggle_header_menu__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_set_background_cruise_cards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/set-background-cruise-cards */ "./js/modules/set-background-cruise-cards.js");
/* harmony import */ var _modules_set_background_cruise_cards__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_set_background_cruise_cards__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./js/modules/set-background-cruise-cards.js":
/*!***************************************************!*\
  !*** ./js/modules/set-background-cruise-cards.js ***!
  \***************************************************/
...
var cardOverlays = document.querySelectorAll('.cruise-card__overlay');
if (cardOverlays) {
  var checkRetinaDisplay = function checkRetinaDisplay() {
    if (window.devicePixelRatio > 1) {
      for (var i = 0; i < cardOverlays.length; i++) {
        cardOverlays[i].style.background = "linear-gradient(180deg, rgba(1, 28, 64, 0) 50%, #011C40 100%), url(\"../img/cruise-card-".concat(i + 1, "@2x.webp\")");
      }
    } else {
      for (var _i = 0; _i < cardOverlays.length; _i++) {
        cardOverlays[_i].style.background = "linear-gradient(180deg, rgba(1, 28, 64, 0) 50%, #011C40 100%), url(\"../img/cruise-card-".concat(_i + 1, ".webp\")");
      }
    }
    cardOverlays.forEach(function (el) {
...
/***/ "./js/modules/toggle-header-menu.js":
/*!******************************************!*\
  !*** ./js/modules/toggle-header-menu.js ***!
  \******************************************/
/*! no static exports found */
...
var navigationMenu = document.querySelector('.main-header__nav');
var menuToggleButton = document.querySelector('.main-header__menu-button');
if (mainHeader && navigationMenu && menuToggleButton) {
  ...
  var setMenuToggle = function setMenuToggle(evt) {
    evt.preventDefault();
